...
const About = () => {
  return (
    ...
    <div className="about">
      <p>Soy Martín Pose, un desarrollador de software con más de dos años de experiencia en Minsait, donde he trabajado en proyectos basados en Java y Oracle SQL para clientes como Naturgy.</p> 
